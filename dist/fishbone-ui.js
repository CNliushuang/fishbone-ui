(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["fishboneUi"] = factory();
	else
		root["fishboneUi"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NodeList = __webpack_require__(2);
	
	var _NodeList2 = _interopRequireDefault(_NodeList);
	
	var _FbuiInput = __webpack_require__(65);
	
	var _FbuiInput2 = _interopRequireDefault(_FbuiInput);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var fishboneUi = {
	  $: _NodeList2.default,
	  FbuiInput: _FbuiInput2.default
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var id = "-!babel!../node_modules/vue-loader/lib/selector.js?type=script&index=0!./FbuiInput.vue"
	hotAPI.createRecord(id, module.exports)
	module.hot.accept(["-!babel!../node_modules/vue-loader/lib/selector.js?type=script&index=0!./FbuiInput.vue","-!vue-html-loader!../node_modules/vue-loader/lib/selector.js?type=template&index=0!./FbuiInput.vue"], function () {
	var newOptions = require("-!babel!../node_modules/vue-loader/lib/selector.js?type=script&index=0!./FbuiInput.vue")
	if (newOptions && newOptions.__esModule) newOptions = newOptions.default
	var newTemplate = require("-!vue-html-loader!../node_modules/vue-loader/lib/selector.js?type=template&index=0!./FbuiInput.vue")
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-rewriter.js?id=_v-2b2bf881&file=FbuiInput.vue!../node_modules/vue-loader/lib/selector.js?type=style&index=0!./FbuiInput.vue", function() {
				var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-rewriter.js?id=_v-2b2bf881&file=FbuiInput.vue!../node_modules/vue-loader/lib/selector.js?type=style&index=0!./FbuiInput.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".inputBox{display: inline-block;position: relative;}\n.faInput{position:absolute;right:5px;top:6px;}\n.fbui-input{\n    color: #5e5e5e;\n    font-family: Microsoft yahei;\n    width: 236px;\n    height: 28px;\n    border: 1px solid #d2d2d2;\n    border-radius: 2px;\n    text-indent: 6px;\n}\n.fbui-input:focus{\n    border-color: #66afe9;\n    outline: 0;;\n    box-shadow: inset 0 1px 1px rgba(0,0,0,.075),0 0 8px rgba(102,175,233,.6);\n}\n.fbui-input.warn{\n    border-color:#f0ad4e;\n}\n.fbui-input.warn.icon{\n    background:url('/src/images/fbuiInput/warning.png') no-repeat right;\n}\n.fbui-input.warn:focus{\n    outline: 0;\n    box-shadow: inset 0 1px 1px rgba(240,173,78,.075),0 0 8px rgba(240,173,78,.6);\n}\n.fbui-input.error{\n    border-color:#f00;\n}\n.fbui-input.error.icon{\n    background:url('/src/images/fbuiInput/error.png') no-repeat right;\n}\n.fbui-input.error:focus{\n    outline: 0;\n    box-shadow: inset 0 1px 1px rgba(256,0,0,.075),0 0 8px rgba(256,0,0,.6);\n}\n.fbui-input.success{\n    border-color:#5cb85c;\n}\n.fbui-input.success.icon{\n    background:url('/src/images/fbuiInput/success.png') no-repeat right;\n}\n.fbui-input.success:focus{\n    outline: 0;\n    box-shadow: inset 0 1px 1px rgba(92,184,92,.075),0 0 8px rgba(92,184,92,.6);\n}\ninput:disabled, input[disabled] {\n    font-family: Microsoft yahei;\n    color: #000;\n    border: 1px solid #d2d2d2;\n    border-radius: 3px;\n    background: #f5f5f5;\n    cursor: not-allowed;\n}\n.fbui-input-group {\n    position: relative;\n    border: 1px solid #d2d2d2;\n}\n.fbui-input-group .input-opt {\n    float: right;\n    background: #fff;\n    width: 22px;\n    height: 28px;\n    cursor: pointer;\n    vertical-align: middle;\n}\n.fbui-input-group .fbui-input-box {\n    margin-right: 22px;\n}\n.fbui-input-group input {\n    color: #585858;\n    border: none !important;\n    display: block;\n    font-size: 12px;\n}\n.fbui-input-group .fbui-drop-list {\n    z-index: 9;\n    background: #fff;\n    display: none;\n    max-height: 200px;\n    overflow: auto;\n    margin-top: -1px;\n    box-sizing: border-box;\n    width: 100%;\n    position: absolute;\n    top: 100%;\n    left: 0;\n    border: 1px solid #d2d2d2;\n}\n.fbui-input-group .fbui-drop-list li {\n    white-space: nowrap;\n    text-overflow: ellipsis;\n    overflow: hidden;\n    font-size: 12px;\n    color: #585858;\n    cursor: pointer;\n    padding: 0 4px;\n    height: 27px;\n    line-height: 27px;\n    border-bottom: 1px solid #d2d2d2;\n}\n.ac {\n    text-align: center;\n}", ""]);
...
/***/ function(module, exports) {
	...
	// <template>
	//     <div class="inputBox">
	//     <input class="fbui-input" :class="{'warn': type=='warn','success': type=='success','error': type=='error'}" v-model="value" type="text" :disabled="disabled" :placeholder="placeHolder" :readonly="readonly" @input="onChange|debounce 500" :maxlength="maxLength">
	//     <label class="faInput fa {{fa}}" v-if="fa"></label>
	//     </div>
	// </template>
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        onChange: function onChange(ev) {
	            ...
	            this.$dispatch('change-data', this.value);
	        }
	    }
	};
	// </script>
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"inputBox\">\n    <input class=\"fbui-input\" :class=\"{'warn': type=='warn','success': type=='success','error': type=='error'}\" v-model=\"value\" type=\"text\" :disabled=\"disabled\" :placeholder=\"placeHolder\" :readonly=\"readonly\" @input=\"onChange|debounce 500\" :maxlength=\"maxLength\">\n    <label class=\"faInput fa {{fa}}\" v-if=\"fa\"></label>\n    </div>";

/***/ }
/******/ ])
});
;
//# sourceMappingURL=fishbone-ui.js.map